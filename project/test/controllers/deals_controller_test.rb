...
class DealsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deal" do
    assert_difference("Deal.count") do
      post deals_url, params: { deal: { comment: @deal.comment, customer: @deal.customer, date: @deal.date, seller: @deal.seller } }
    end
  ...
  test "should update deal" do
    patch deal_url(@deal), params: { deal: { comment: @deal.comment, customer: @deal.customer, date: @deal.date, seller: @deal.seller } }
